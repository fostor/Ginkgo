...
using Fostor.Ginkgo.Web.Models.Account;
using Fostor.Ginkgo.Web.Views.Shared.Components.TenantChange;

namespace Fostor.Ginkgo.Web.Controllers
{
    public class AccountController : GinkgoControllerBase
    {
        ...
        public async Task<ActionResult> TenantChangeModal()
        {
            ...
            var tenants = await _sessionAppService.GetAllTenants();
