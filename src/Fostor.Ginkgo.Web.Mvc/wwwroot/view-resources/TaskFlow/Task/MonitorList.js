(function () {
    $(function () {
        ...
        function search() {
            ...
            _dataService.searchMonitorList(searchDto).done(function (data) {
                BindTable_100(data);
            });
        }
                ...
                columns: [
                    ...
                    { data: 'taskName', width: '80px' },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            content += '   <a href="' + abp.appPath + 'TaskFlow/Task/ViewForm?id=' + data + '" class="waves-effect waves-block" ><i class="tiny material-icons">reorder</i></a>';
                            content += '</div>';
                            return content;
                        }
                    },
